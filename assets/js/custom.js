...
document.addEventListener("DOMContentLoaded", () => {
  const range = document.getElementById("gmvRange");
  ...
  function updateCalculator() {
    ...
    /* GMV Value */
    gmvValue.textContent = formatNumber(value);
    /* Financial Impact (1.25%) */
    const impact = Math.round(value * 0.0125);
    impactValue.textContent = formatNumber(impact);
    /* Slider Progress */
